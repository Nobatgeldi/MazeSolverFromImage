...
class Solver:
    ...
    def __init__(self, maze):
        ...
        logger.info("Loaded image '{0}' ({1} = {2} pixels).".format(
        ...
        self.image.save("resim/SolvedMaze_worked.jpg")
        ...
        logger.info("Yeni baslangic kordinat x:{0} y: {1}".format(self.START[0], self.START[1]))

        # yeni bitiş noktasını bul
        self.END = self.END[0]-35, self.END[1]
        logger.info("Yeni cikis kordinat x:{0} y: {1}".format(self.END[0], self.END[1]))
        self._cleanImage()
        ...
        self.img = cv2.imread("resim/SolvedMaze_cleaned.jpg", cv2.IMREAD_GRAYSCALE)
    ...
    def _cropImage(self, x, y, w, h):
        ...
        cropped.save("resim/SolvedMaze_copped.jpg")
        return cropped

    def _imageWorking(self):
        logger.info("Image restoring...")
    ...
    def _cleanImage(self):
        ...
        self.image.save("resim/SolvedMaze_cleaned.jpg")
